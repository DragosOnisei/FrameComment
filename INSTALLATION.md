# FrameComment Installation Guide

Step-by-step instructions for installing FrameComment on various platforms.

## Quick Install (5 Minutes)

```bash
# 1. Download
git clone https://github.com/yourusername/framecomment.git && cd framecomment
...
### Step 1: Get FrameComment

**Option A: Git Clone**
```bash
git clone https://github.com/yourusername/framecomment.git
cd framecomment
```
...
```
NAME                   STATUS
framecomment-app        Up (healthy)
framecomment-worker     Up (healthy)
framecomment-postgres   Up (healthy)
framecomment-redis      Up (healthy)
```
...
# Should be: postgresql://framecomment:PASSWORD@postgres:5432/framecomment?schema=public
...
# Remove images
docker rmi framecomment/framecomment:latest postgres:16-alpine redis:7-alpine
```
