...
This directory contains GitHub Actions workflows for automated testing of FrameComment.
...
Tests a fresh installation of FrameComment with the latest production compose configuration.
...
- Check available tags: https://hub.docker.com/r/dragosonisei/framecomment/tags
...
[![Docker Integration Tests](https://github.com/DragosOnisei/FrameComment/actions/workflows/docker-integration-tests.yml/badge.svg)](https://github.com/DragosOnisei/FrameComment/actions/workflows/docker-integration-tests.yml)
```
