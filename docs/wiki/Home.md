...
Welcome to the FrameComment documentation wiki. This content reflects the application capabilities and behavior as of version **1.0.0**.

The canonical wiki lives on GitHub: https://github.com/DragosOnisei/FrameComment/wiki
