...
FrameComment supports multiple languages. The language is set by an admin under **Settings → Language** and applies to everything: admin pages, client share pages, and email notifications.
...
📁 [`src/locales/en.json`](https://github.com/DragosOnisei/FrameComment/blob/main/src/locales/en.json)
...
- **GitHub Issue** — [open an issue](https://github.com/DragosOnisei/FrameComment/issues/new) and attach your translated file
- **Pull Request** — add your `xx.json` to `src/locales/` and open a PR
- **Direct message** — reach out via the contact info on [GitHub](https://github.com/DragosOnisei/FrameComment)
...
1. Download the existing file (e.g., [`nl.json`](https://github.com/DragosOnisei/FrameComment/blob/main/src/locales/nl.json))
...
- **FrameComment** — the app name, always stays as-is
- **Brand names** — GitHub, Docker Hub, Gotify, ntfy, Pushover, Telegram, Google Calendar, Outlook, Apple Calendar
