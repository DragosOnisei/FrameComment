...
# FrameComment Quadlet Configuration Script
# This script helps you configure the Quadlet files with your secrets

set -e

echo "🔧 FrameComment Quadlet Configuration"
echo "===================================="
echo ""
...
# Ask for domain
read -p "🌐 Enter your domain (e.g., https://framecomment.example.com) [http://localhost:4321]: " DOMAIN
...
# Configure postgres
sed -i.bak "s#CHANGE_THIS_PASSWORD#${POSTGRES_PASSWORD}#g" framecomment-postgres.container
echo "✅ Configured framecomment-postgres.container"

# Configure redis
sed -i.bak "s#CHANGE_THIS_PASSWORD#${REDIS_PASSWORD}#g" framecomment-redis.container
echo "✅ Configured framecomment-redis.container"
...
echo "✅ Configured framecomment-app.container"
...
echo "✅ Configured framecomment-worker.container"

# Save secrets to file
cat > .secrets << EOF
# FrameComment Secrets - KEEP THIS FILE SECURE!
# Generated: $(date)
...
echo "     podman pull docker.io/dragosonisei/framecomment:latest"
echo "  5. Start services:"
echo "     sudo systemctl start framecomment-postgres.service"
echo "     sudo systemctl start framecomment-redis.service"
echo "     sudo systemctl start framecomment-app.service"
echo "     sudo systemctl start framecomment-worker.service"
echo ""
echo "🎉 Done!"
