...
# FrameComment Directory Setup Script
# Creates the required directory structure for FrameComment

set -e

echo "📁 FrameComment Directory Setup"
echo "=============================="
echo ""

BASE_DIR="/podman/framecomment"
