...
export async function POST(
  ...
  try {
    ...
    // 4.1.1+: File attachments are ALWAYS enabled. The old
    // `allowClientAssetUpload` gate was removed — anyone who can comment
    // can attach files (voice comments already bypassed it anyway).
