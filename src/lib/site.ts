...
export const SITE_DESCRIPTION =
  'FrameComment keeps every cut, every comment and every delivery between your production team and your clients organized. Frame-accurate feedback, client-friendly share links, version stacks, AI transcripts and honest pay-as-you-grow pricing.'
...
export const SITE_KEYWORDS = [
  ...
  'video review and delivery software',
