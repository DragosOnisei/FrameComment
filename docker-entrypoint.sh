...
# FrameComment Docker Entrypoint Script
...
wait_for_app() {
    ...
    # APP_HOST: Container/service name (default: framecomment-app)
    # APP_PORT: Application port (default: 4321)
    APP_HOST=${APP_HOST:-framecomment-app}
